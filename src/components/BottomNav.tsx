...
export default function BottomNav() {
  ...
  return (
    <nav aria-label="Navegación principal" className="fixed bottom-0 left-0 right-0 z-40 border-t border-card-border bg-card/90 backdrop-blur-lg text-foreground">
